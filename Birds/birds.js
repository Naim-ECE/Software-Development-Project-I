...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll(".content").forEach((card) => {
    card.addEventListener("click", () => {
      ...
      window.location.href = `../Content_Page/content.html?category=birds&animal=${encodeURIComponent(
        animalName
      )}`;
    });
  });
...
const animals = [
  { name: "Cassowary", element: document.querySelector(".obj1") },
  { name: "Chicken", element: document.querySelector(".obj2") },
  { name: "Duck", element: document.querySelector(".obj3") },
  { name: "Eagle", element: document.querySelector(".obj4") },
  { name: "Hawk", element: document.querySelector(".obj5") },
  { name: "Hummingbirds", element: document.querySelector(".obj6") },
  { name: "Magpie", element: document.querySelector(".obj7") },
  { name: "Owl", element: document.querySelector(".obj8") },
  { name: "Parrot", element: document.querySelector(".obj9") },
  { name: "Pigeon", element: document.querySelector(".obj10") },
  { name: "Sparrow", element: document.querySelector(".obj11") },
  { name: "Swallow", element: document.querySelector(".obj12") },
];
