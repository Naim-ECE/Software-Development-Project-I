...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll(".content").forEach((card) => {
    card.addEventListener("click", () => {
      ...
      window.location.href = `../Content_Page/content.html?category=fish&animal=${encodeURIComponent(
        animalName
      )}`;
    });
  });
...
const animals = [
  { name: "Catfish", element: document.querySelector(".obj1") },
  { name: "Dolphin", element: document.querySelector(".obj2") },
  { name: "Goldfish", element: document.querySelector(".obj3") },
  { name: "Koi", element: document.querySelector(".obj4") },
  { name: "Rohu Fish", element: document.querySelector(".obj5") },
  { name: "Shark", element: document.querySelector(".obj6") },
  { name: "Tuna", element: document.querySelector(".obj7") },
  { name: "Whale", element: document.querySelector(".obj8") },
];
