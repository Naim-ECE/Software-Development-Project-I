...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll(".content").forEach((card) => {
    card.addEventListener("click", () => {
      ...
      window.location.href = `../Content_Page/content.html?category=amphibians&animal=${encodeURIComponent(
        animalName
      )}`;
    });
  });
...
const animals = [
  { name: "Anthracosauria", element: document.querySelector(".obj1") },
  { name: "Axolotl", element: document.querySelector(".obj2") },
  { name: "Caecilian", element: document.querySelector(".obj3") },
  { name: "Diplocaulus", element: document.querySelector(".obj4") },
  { name: "Frog", element: document.querySelector(".obj5") },
  { name: "Labyrinthodontia", element: document.querySelector(".obj6") },
  { name: "Microsauria", element: document.querySelector(".obj7") },
  { name: "Salamander", element: document.querySelector(".obj8") },
];
