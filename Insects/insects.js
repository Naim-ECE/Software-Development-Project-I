...
const animals = [
  ...
  { name: "Grasshopper", element: document.querySelector(".obj4") },
  { name: "Honeybee", element: document.querySelector(".obj5") },
  { name: "Hornet", element: document.querySelector(".obj6") },
  { name: "Ladybug", element: document.querySelector(".obj7") },
  { name: "Mosquito", element: document.querySelector(".obj8") },
];
